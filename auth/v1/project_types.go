...
type ProjectSpec struct {
	...
	ClusterDeletePolicy DeletePolicy       `json:"clusterDeletePolicy,omitempty"`
}
...
// RetainResource determine if retain resource when delete project
func (object *Project) RetainResource() bool {
	return object.Spec.ClusterDeletePolicy == Delete
}
