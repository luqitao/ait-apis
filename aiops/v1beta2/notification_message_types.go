...
// NotificationSubscriptionEqual check if the condition recording status of the same notification subscription
func (nm *NotificationMessageCondition) NotificationSubscriptionEqual(condition *NotificationMessageCondition) bool {
	return nm.Notification == condition.Notification && nm.Method == condition.Method && nm.ReceiverNamespace == condition.ReceiverNamespace && nm.ReceiverName == condition.ReceiverName
}
